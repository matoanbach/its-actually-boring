...
public:
    ...
    void testMaxSizeAVL() {
        ...
        try {
            ...
            while (true) {
                ...
                count += 1000; // Increase the target by 1000 nodes each iteration.
            }
        } catch (bad_alloc &e) {
            cout << "[AVL] Caught bad_alloc after approximately " << count 
    ...
    void testMaxSizeMap() {
        ...
        try {
            ...
            cout << "[map] Caught bad_alloc after inserting approximately " << count 
